    ...
    var geoFileName = "data/usa.json"; // GeoJSON data file
    ...
    var usTopoJSON, geoJsonData, chartData = undefined; // GeoJSON and charting data objects  
    ...
    d3.queue()
      ...
      .await(function(error, file1, file2) { 
        ...
        usTopoJSON = file1; // GeoJSON map data
        chartData = file2;  // Data for charting on the map
        console.log("usTopoJSON", usTopoJSON)
      
      // Convert topoJSON to geoJSON
        geoJsonData = topojson.feature(usTopoJSON, usTopoJSON.objects.states);

        // Remove Alaska
        geoJsonData.features = geoJsonData.features.filter(function(d) { 
   ...
   function updateDisplay(year) {
      ...
      mapProp = "id"; // Propery name to map to on each geoJSON feature object
      scaleValue = 1; // Map scaling
      xOffset = 0; // Map xoffset
      yOffset = 0; // Map yoffset
      ...
      $.each(geoJsonData.features, function(key, value) { 
          ...
          var stateAbbr = value.properties["id"]
